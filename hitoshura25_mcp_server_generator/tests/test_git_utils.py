...
class TestGetGitHubUsername:
    ...
    def test_github_user_config(self):
        ...
        with patch("subprocess.run") as mock_run:
            mock_run.return_value = MagicMock(stdout="hitoshura25\n", returncode=0)
    ...
    def test_remote_url_ssh(self):
        ...
        with patch("subprocess.run") as mock_run:
            ...
            mock_run.side_effect = [
                ...
                MagicMock(stdout="git@github.com:hitoshura25/repo.git\n", returncode=0),
            ]
            assert get_github_username() == "hitoshura25"
...
class TestSanitizeUsername:
    ...
    def test_combined_transformations(self):
        ...
        assert sanitize_username("  John  Smith  ") == "john-smith"
        assert (
            sanitize_username("john@example.com") == "johnexample-com"
        )  # Dot → hyphen, @ removed
...
class TestApplyPrefix:
    ...
    def test_auto_mode_with_detection(self):
        ...
        with patch(
            "hitoshura25_mcp_server_generator.git_utils.get_github_username"
        ) as mock_get:
